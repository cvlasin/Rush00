...
<div class="products">
	<table>
		<?php
					...
					$list_products = readFromCategory("drugs");
					$i = 1;
					echo '<tr>';
					...
					<td class="produs">
						...
						<a href="phones.php?action=add&id=<?php echo $row['id'];?>&price=<?php echo $row['price'];?>"><img src="Resurse/addtocart.png" alt = "Add to cart" style="width: 50px; height: 50px;"> </a>
					</td>
					<?php
						if ($i % 4 == 0){
							echo '</tr>';
